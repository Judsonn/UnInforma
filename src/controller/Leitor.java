 ...
 */
    public static ArrayList montarListaProjeto(String br, String areaProj) throws ParseException, IOException {
        ...
        projetoString = br;
        linha = projetoString.split("\n");

        for(int i=0; i<linha.length;i++) {
            //Define split do csv
            projetoStringArray = linha[i].split(",");
 ...
 */
    public static ArrayList montarListaCurso(String br, String campus) throws ParseException, IOException {
  ...
  //Enquanto a linha não for nula, ele lê cada linha com as informações do projeto
        cursoString = br;
        linha = cursoString.split("\n");

        for(int i=0; i<linha.length;i++) {
            //Define split do csv
            cursoStringArray = linha[i].split(",");
